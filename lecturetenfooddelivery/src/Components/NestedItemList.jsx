    ...
    return (
        <div className='border-gray-300  border-b-[1px] py-2 px-2 flex justify-between'>
            ...
            <div className='w-3/12 p-4'>
                ...
                {nested.imageId ? <button className='bg-white text-sm px-5 py-2 cursor-pointer hover:shadow-lg border-b-2 border-gray-200  text-green-700 rounded-sm shadow-2xl relative bottom-7 left-8'>ADD</button> :
                                 <button className='bg-white text-sm px-5 py-2 cursor-pointer hover:shadow-lg border-b-2 border-gray-200  text-green-700 rounded-sm shadow-2xl relative bottom-0 left-8'>ADD</button>
                }
            </div>
        </div>
    )
